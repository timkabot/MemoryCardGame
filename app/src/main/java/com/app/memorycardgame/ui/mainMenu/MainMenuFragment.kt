...
import com.app.memorycardgame.presentation.mainMenu.IMainMenuView
...
class MainMenuFragment : BaseFragment(), IMainMenuView {
    ...
    override fun onPlayButtonClicked() {
        nickname_text_view.text?.let {
            ...
            else context?.toast("Please enter your nickname")
        }
